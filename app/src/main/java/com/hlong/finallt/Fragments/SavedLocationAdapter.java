...
public class SavedLocationAdapter extends BaseAdapter {
    ...
    public SavedLocationAdapter(Context c, String[] tittle, String[] des,String[] des2, int[]Image1) {
        context = c;
        this.tittle = tittle;
        this.des = des;
        this.des2 = des2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.row_item_saved_diadiem, null);
        }
        ...
        TextView textView3 = convertView.findViewById(R.id.tvdiem);
